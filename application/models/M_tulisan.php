...
class M_tulisan extends CI_Model
{
	...
	{
		$hsl = $this->db->query("UPDATE tulisan SET tulisan_judul='$judul',tulisan_isi='$isi',tulisan_kategori_id='$kategori_id',tulisan_kategori_nama='$kategori_nama',tulisan_pengguna_id='$user_id',tulisan_author='$user_nama',tulisan_slug='$slug',tulisan_deskripsi='',tulisan_lang='id' WHERE tulisan_id='$tulisan_id'");
		return $hsl;
	}
