...
<body>
                ...
                <div class="sidebar-content">
                        ...
                        <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                            ...
                            <div class="content-header-item">
                                <a class="link-effect font-w700" href="<?php echo base_url() . 'admin/dashboard' ?>">
                                    ...
                                    <span class="font-size-xl text-dual-primary-dark">PESONA</span><span class="font-size-xl text-success">KARAWANG</span>
                                </a>
                            </div>
                            <!-- END Logo -->
                        </div>
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li>
                                <a href="<?php echo base_url() . 'admin/tour' ?>"><i class="si si-star"></i><span class="sidebar-mini-hide">Tour</span></a>
                            </li>
                            <li>
                                <a class="active" href="<?php echo base_url() . 'admin/wisata' ?>"><i class="si si-badge"></i><span class="sidebar-mini-hide">Tampilan Wisata</span></a>
                            </li>
                            <li>
                    ...
                    <div class="col-md-12">
                        <div class="block">
                            <div class="block-header block-header-default">
                                <h3 class="block-title">Wisata</h3>
                                <div class="block-options">
                                    <a href="<?php echo site_url('admin/wisata/add_new'); ?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                </div>
                            </div>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/wisata/edit/' . $row->kd_wisata); ?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->kd_wisata; ?>"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
        ...
        <footer id="page-footer" class="opacity-0">
            <div class="content py-20 font-size-xs clearfix">
                <div class="float-right">
                    Created with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" target="_blank">Kelompok 5</a>
                </div>
                <div class="float-left">
                    <a class="font-w600" target="_blank">pesonakarawang.com</a> &copy; <span class="js-year-copy"><?php echo date('Y'); ?></span>
                </div>
            </div>
        </footer>
        <!-- END Footer -->
    ...
    <!-- Modal Hapus -->
    <form action="<?php echo base_url() . 'admin/wisata/hapus_wisata' ?>" method="post">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Anda yakin mau menghapus Wisata ini?</p>
