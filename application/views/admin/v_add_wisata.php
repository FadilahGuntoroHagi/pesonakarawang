...
<body>
    ...
    <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
        ...
        <main id="main-container">
            <!-- Page Content -->
            <div class="content">
                <form action="<?php echo base_url() . 'admin/wisata/simpan_wisata' ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="xnama" class="form-control" placeholder="Nama Wisata" required>
                                    </div>
                                    <div class="form-group">
