...
<body>
    ...
    <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
        ...
        <main id="main-container">
            <!-- Page Content -->
            <div class="content">
                <form action="<?php echo base_url() . 'admin/wisata/update_wisata' ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Edit Wisata</h3>
                                </div>
                                <div class="block-content">

                                    <div class="form-group">
                                        <input type="text" name="xnama" value="<?php echo $b['nama']; ?>" class="form-control" placeholder="Nama Wisata" required>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="block">
                                ...
                                <div class="block-content block-content-full block-content-md bg-body-light">
                                    <input type="hidden" name="kode" value="<?php echo $b['kd_wisata']; ?>" required>
