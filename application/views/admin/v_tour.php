...
<body>
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li>
                                <a class="active" href="<?php echo base_url() . 'admin/tour' ?>"><i class="si si-star"></i><span class="sidebar-mini-hide">Tour</span></a>
                            </li>
                            <li>
                                <a href="<?php echo base_url() . 'admin/wisata' ?>"><i class="si si-badge"></i><span class="sidebar-mini-hide">Tampilan Wisata</span></a>
                            </li>
                            <li>
                    ...
                    <div class="col-md-12">
                        <div class="block">
                            <div class="block-header block-header-default">
                                <h3 class="block-title">Tour Wisata</h3>
                                <div class="block-options">
                                    <a href="<?php echo site_url('admin/tour/add_new'); ?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                </div>
                            </div>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/tour/get_edit/' . $row->kd_compare); ?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
    ...
    <!-- Modal Hapus -->
    <form action="<?php echo base_url() . 'admin/tour/hapus_tour' ?>" method="post">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Anda yakin mau menghapus Tour ini?</p>
