...
<body>
    ...
    <div id="page-container" class="main-content-boxed">
        ...
        <main id="main-container">
            <!-- Page Content -->
            <div class="bg-image" style="background-image: url('assets/img/bg-login1.jpg');">
                <div class="row mx-0 bg-black-op">
                    <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                        <div class="p-30 invisible" data-toggle="appear">
                            <p class="font-size-h3 font-w600 text-white">
                                Welcome to PESONAKARAWANG.COM
                            </p>
                        ...
                        <div class="content content-full">
                            ...
                            <div class="px-30 py-10">
                                <a class="link-effect font-w700" href="<?php echo base_url(); ?>">
                                    <i class=""></i>
                                    <span class="font-size-xl text-primary-dark">PESONA</span><span class="font-size-xl text-success">KARAWANG</span>
                                </a>
