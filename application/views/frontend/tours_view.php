                                ...
                                <div class="<?php echo $rata; ?>">
                                    ...
                                    <div class="text-thumbs">
                                        ...
                                        <div class="text">
                                            ...
                                            <span class="price">Start from <span class="amout"><b><?php echo 'Rp ' . number_format($row->rate); ?></b></span> per Ticket </span>
                                            <?php echo $row->detail; ?>
                                            <a href="<?php echo site_url('reservation'); ?>" class="awe-btn awe-btn-13">ORDER SEKARANG</a>
                                        </div>
