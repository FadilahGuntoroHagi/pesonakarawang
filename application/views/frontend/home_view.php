...
<head>
    <meta charset="utf-8">
    <!-- TITLE -->
    <title>Welcome to pesonakarawang</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
    <meta name="format-detection" content="telephone=no">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <link rel="shortcut icon" href="<?php echo base_url() . 'theme/images/favicon2.png' ?>" />
...
<body>
    ...
    <div id="page-wrap">
            ...
            <div class="container">
                <div class="check-availability">
                    <div class="row v-align">
                        <div class="col-lg-3">
                            <h2>Jelajahi Kota Karawang</h2>
                        </div>
                        <div class="col-lg-9">
                            <div class="availability-form">
                                <div class="vailability-submit">
                                    <a href="<?php echo site_url('tours'); ?>" class="awe-btn awe-btn-13">Ayo Mulai Liburan Anda!!</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- TOURS DETAIL -->
        <section class="section-tours-detail bg-white">
            <div class="container">

                <!-- COMPARE ACCOMMODATION -->
                <div class="tours-detail_compare">
                    <div class="row">
                        <div class="col col-xs-12 col-lg-6 col-lg-offset-3">
                            <div class="ot-heading row-20 mb30 text-center">
                                <h2 class="shortcode-heading">Wisata Karawang</h2>
                            </div>
                        </div>
                    </div>

                    <div class="tours-compare_content">

                        <div class="row">
                            <!-- ITEM -->

                            <?php
                            foreach ($tour->result() as $j) :
                            ?>


                                <div class="col-sm-3 col-md-3 col-lg-3">
                                    <div class="tours-compare_item">
                                        <div class="img">
                                            <a href="<?php echo site_url('tours'); ?>"><img class="img img-responsive" src="<?php echo base_url() . 'assets/images/' . $j->gambar_large; ?>" alt="<?php echo $j->type; ?>"></a>
                                        </div>

                                        <div class="text">
                                            <h2><a herf="<?php echo site_url('tours'); ?>"><?php echo $j->type; ?></a></h2>
                        ...
                        <div class="text-center">
                            <a href="<?php echo site_url('tours'); ?>" class="awe-btn awe-btn-default font-hind f12 bold btn-medium mt15">View More</a>
                        </div>
        ...
        <!-- BLOG -->
        <section class="section-blog bg-white"><br><br><br>
            <div class="container">
                <div class="blog">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-md-pull-8">
                            <div class="sidebar">
                                ...
                                <div class="widget widget_upcoming_events">
                                    <h4 class="widget-title">Dapatkan Promo Menariknya</h4>
                                    <ul>
                                        <?php
